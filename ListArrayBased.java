...
public class ListArrayBased<T> implements ListInterface<T>{
    ...
    /**
     * Field declaration of the max list size, as an int value
     */
    private static final int MAX_LIST = 3;
    /**
     * Field declaration of the generic fixed sized array items
     */
    ...
    /**
     * Class constructor that initializes the array items to size 3 and numItems to the value 0
     */
