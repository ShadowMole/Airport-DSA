...
public class Driver {
    ...
    /**
     * The switch that runs the menu for the project
     * 
     * @param command
     * @param runways
     * @param runwayNames
    ...
    /**
     * Adds a new plane to a runway. Each plane contains a designated runway, runway name, and a unique flight number.
     * 
     * @param runways
     * @param runwayNames
     * @param flightNumbers
    ...
    /**
     * A plane is removed from the runway that it was on
     * 
     * @param runways
     * @param hangar
     * @param info
    ...
    /**
     * Prints out the number of planes that have taken off
     * 
     * @param info
     */
    ...
    /**
     * Prints out the number of planes waiting to take off
     * 
     * @param hangar
     */
    ...
    /**
     * Allows a plane to reenter a runway if it was denied clearance for take-off 
     * 
     * @param runways
     * @param hangar
     * @throws IOException
    ...
    /**
     * Adds a new runway with a unique name
     * 
     * @param runways
     * @param runwayNames
     * @throws IOException
    ...
    /**
     * Removes a currently open runway
     * If there are any planes that are on the runway that is to be closed then they have to be moved to another open runway
     * If there are any planes that are in the hanger waiting to get to the runway that is to be closed they have to be moved to another hanger for a different runway
     * 
     * @param runways
     * @param hangar
     * @throws IOException
